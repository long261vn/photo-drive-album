...
export default function AlbumPage() {
  ...
  return (
    <main className="album-page">
      <header className="album-page__header"><button className="back-link" type="button" onClick={() => setLocation("/")}><ArrowLeft size={18} strokeWidth={1.8} /> Tất cả thiết kế</button><img className="header-mark" src="/manus-storage/liturgical-logo_d82d1f4f.png" alt="" /><span className="header-note">{isLive ? "Google Drive" : "Lịch phụng vụ"}</span></header>
